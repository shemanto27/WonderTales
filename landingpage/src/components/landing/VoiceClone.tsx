      ...
      <div className="mx-auto max-w-7xl">
        <div className="relative rounded-[2rem] border border-white/10 bg-navy-900/50 p-6 sm:p-10 lg:p-16 shadow-2xl shadow-black/40 mt-10">
          ...
          <div className="relative z-10 flex flex-col gap-12 lg:flex-row lg:items-center justify-between w-full min-h-[300px]">
            ...
            <div className="relative z-20 flex justify-center lg:justify-start lg:w-1/3 order-3 lg:order-1">
              {/* Hand with Phone Mockup */}
              <div className="h-[300px] sm:h-[400px] lg:h-[550px] lg:absolute lg:left-[-40px] lg:-bottom-[100px] shrink-0 hover:scale-105 transition-transform duration-500 pointer-events-none">
                <img src={handImg} alt="Mobile App in Hand" className="h-full w-auto object-contain max-w-none drop-shadow-2xl" />
              </div>
            </div>

            <div className="lg:absolute lg:left-1/2 lg:top-1/2 lg:-translate-x-1/2 lg:-translate-y-1/2 z-10 flex justify-center mt-4 lg:mt-0 order-2">
            ...
            <div className="max-w-md space-y-4 text-left z-20 order-1 lg:order-3">
