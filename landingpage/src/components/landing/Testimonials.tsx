...
import avatar2 from '../../assets/image 22.png'
import avatar3 from '../../assets/image 23.png'
import avatar4 from '../../assets/cartoon-boy-with-backpack-tablet 1.png'
      ...
      <div className="mx-auto max-w-7xl text-center">
        ...
        <div className="mt-16 grid sm:grid-cols-2 relative">
          ...
          {[
            ...
            <div key={t.name} className={`p-10 text-center ${i < 2 ? 'sm:pb-16' : 'sm:pt-16'}`}>
